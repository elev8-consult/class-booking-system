...
export default function ThankYouPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#EFE7DA' }}>
          ...
          <div className="space-y-4 text-center">
            <div>
              <a
                ...
                className="inline-flex items-center justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[#BFA980] hover:bg-[#a08c6a] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#BFA980] w-full"
              >
            ...
            <div>
              <Link
                to="/"
                className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[#BFA980] hover:bg-[#a08c6a] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#BFA980]"
              >
                Return to Home
              </Link>
            </div>
